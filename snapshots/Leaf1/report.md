...
10.255.255.0      0:00:02  aac1.ab84.efa0  Ethernet1
10.255.255.2      0:00:12  aac1.ab98.9c06  Ethernet2
10.255.1.97       0:00:03  001c.eaae.5796  Vlan4093, Port-Channel3
10.255.1.65       0:00:00  001c.eaae.5796  Vlan4094, Port-Channel3
...
Router identifier 10.255.0.3, local AS number 65001
 ...
 *        RD: 10.255.0.3:10 ip-prefix 10.10.12.0/24
                                 -                     -       100     0       ?
 * >      RD: 10.255.0.3:10 ip-prefix 10.10.21.0/24
                                 -                     -       100     0       65100 65002 ?
 ...
 *  ec    RD: 10.255.0.6:10 ip-prefix 10.10.21.0/24
                                 192.168.1.5           -       100     0       65100 65002 i
 * >      RD: 10.255.0.3:10 ip-prefix 10.10.22.0/24
                                 -                     -       100     0       65100 65002 ?
 ...
 *  ec    RD: 10.255.0.6:10 ip-prefix 10.10.22.0/24
                                 192.168.1.5           -       100     0       65100 65002 i
 * >      RD: 10.255.0.3:10 ip-prefix 10.10.31.0/24
                                 -                     -       100     0       65100 65006 ?
 ...
 *  ec    RD: 10.255.0.8:10 ip-prefix 10.10.31.0/24
                                 192.168.1.8           -       100     0       65100 65006 i
 * >      RD: 10.255.0.3:10 ip-prefix 10.10.32.0/24
                                 -                     -       100     0       65100 65006 ?
...
Neighbor Status Codes: m - Under maintenance
  ...
  Spine1_Loopback0         10.255.0.1 4 65100            114       109    0    0 01:17:26 Estab   16     16     14
  Spine2_Loopback0         10.255.0.2 4 65100            114       116    0    0 01:17:27 Estab   16     16     18
```
## show bgp summary
...
------------ ----------- ------------- ----------------------- -------------- ---------- ---------- ----------
10.255.0.1         65100 Established   L2VPN EVPN              Negotiated             16         16         14
10.255.0.2         65100 Established   L2VPN EVPN              Negotiated             16         16         18
10.255.1.97        65001 Established   IPv4 Unicast            Negotiated             11         11         11
10.255.255.0       65100 Established   IPv4 Unicast            Negotiated              8          8          9
10.255.255.2       65100 Established   IPv4 Unicast            Negotiated              8          8          6
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_Spine1_Ethernet1
Et2                            up             up                 P2P_Spine2_Ethernet1
Et3                            up             up                 MLAG_Leaf2_Ethernet3
Et4                            up             up                 MLAG_Leaf2_Ethernet4
Et5                            up             up                 SERVER_Host-A_Ethernet1
Et6                            up             up                 SERVER_Host-B_Ethernet1
Lo0                            up             up                 ROUTER_ID
Lo1                            up             up                 VXLAN_TUNNEL_SOURCE
Ma0                            up             up                 OOB_MANAGEMENT
Po3                            up             up                 MLAG_Leaf2_Port-Channel3
Po5                            down           lowerlayerdown     MLAG_PortChannel
Po6                            down           lowerlayerdown     MLAG_PortChannel
Vl11                           up             up                 VRF_A_VLAN_11
Vl12                           up             up                 VRF_A_VLAN_12
...
Vxlan1 is up, line protocol is up (connected)
  ...
  Source interface is Loopback1 and is active with 192.168.1.3
  ...
  Static VRF to VNI mapping is 
   [VRF_A, 10]
  MLAG Shared Router MAC is 021c.eaae.5796
```
## show ip bgp
 ...
 * >      10.255.0.1/32          10.255.255.0          0       -          100     0       65100 i
 *        10.255.0.1/32          10.255.1.97           0       -          100     0       65100 ?
 * >      10.255.0.2/32          10.255.255.2          0       -          100     0       65100 i
 *        10.255.0.2/32          10.255.1.97           0       -          100     0       65100 ?
 * >      10.255.0.3/32          -                     -       -          -       0       i
 * >      10.255.0.4/32          10.255.1.97           0       -          100     0       ?
 * >Ec    10.255.0.5/32          10.255.255.2          0       -          100     0       65100 65002 i
 *  ec    10.255.0.5/32          10.255.255.0          0       -          100     0       65100 65002 i
 *        10.255.0.5/32          10.255.1.97           0       -          100     0       65100 65002 ?
 * >Ec    10.255.0.6/32          10.255.255.2          0       -          100     0       65100 65002 i
 *  ec    10.255.0.6/32          10.255.255.0          0       -          100     0       65100 65002 i
 *        10.255.0.6/32          10.255.1.97           0       -          100     0       65100 65002 ?
 * >Ec    10.255.0.7/32          10.255.255.2          0       -          100     0       65100 65005 i
 *  ec    10.255.0.7/32          10.255.255.0          0       -          100     0       65100 65005 i
 *        10.255.0.7/32          10.255.1.97           0       -          100     0       65100 65005 ?
 * >Ec    10.255.0.8/32          10.255.255.0          0       -          100     0       65100 65006 i
 *  ec    10.255.0.8/32          10.255.255.2          0       -          100     0       65100 65006 i
 *        10.255.0.8/32          10.255.1.97           0       -          100     0       65100 65006 ?
 * >      192.168.1.3/32         -                     -       -          -       0       i
 *        192.168.1.3/32         10.255.1.97           0       -          100     0       ?
 * >Ec    192.168.1.5/32         10.255.255.2          0       -          100     0       65100 65002 i
 *  ec    192.168.1.5/32         10.255.255.0          0       -          100     0       65100 65002 i
 *        192.168.1.5/32         10.255.1.97           0       -          100     0       65100 65002 ?
 * >Ec    192.168.1.7/32         10.255.255.2          0       -          100     0       65100 65005 i
 *  ec    192.168.1.7/32         10.255.255.0          0       -          100     0       65100 65005 i
 *        192.168.1.7/32         10.255.1.97           0       -          100     0       65100 65005 ?
 * >Ec    192.168.1.8/32         10.255.255.0          0       -          100     0       65100 65006 i
 *  ec    192.168.1.8/32         10.255.255.2          0       -          100     0       65100 65006 i
 *        192.168.1.8/32         10.255.1.97           0       -          100     0       65100 65006 ?
```
## show ip route
...
Gateway of last resort:
 ...
 B E      10.255.0.1/32 [20/0]
           via 10.255.255.0, Ethernet1
 B E      10.255.0.2/32 [20/0]
           via 10.255.255.2, Ethernet2
 C        10.255.0.3/32
           directly connected, Loopback0
 B I      10.255.0.4/32 [200/0]
           via 10.255.1.97, Vlan4093
...
Number of table inserts  : 3171
Number of table deletes  : 3149
Number of table drops    : 0
Number of table age-outs : 3149

Port          Neighbor Device ID       Neighbor Port ID    TTL
---------- ------------------------ ---------------------- ---
Et1           Spine1                   Ethernet1           120
Et2           Spine2                   Ethernet1           120
Et3           Leaf2                    Ethernet3           120
Et4           Leaf2                    Ethernet4           120
Et5           Host-A                   Ethernet1           120
Et6           Host-B                   Ethernet1           120
...
!
interface Ethernet5
   description SERVER_Host-A_Ethernet1
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_Host-B_Ethernet1
...
Arista cEOSLab
Hardware version: 
Serial number: SERHATLEAF1
Hardware MAC address: 001c.eaae.866b
System MAC address: 001c.eaae.866b
...
----------- ---------- ------------ ------------------- ----------
10011       11         static       Port-Channel5       11        
                                    Vxlan1              11        
10012       12         static       Port-Channel6       12        
                                    Vxlan1              12        
