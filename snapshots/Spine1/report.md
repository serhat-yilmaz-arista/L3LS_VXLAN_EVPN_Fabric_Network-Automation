...
10.255.255.1      0:00:37  aac1.ab31.f194  Ethernet1
10.255.255.5      0:00:41  aac1.ab32.520d  Ethernet2
10.255.255.9      0:00:00  aac1.ab0d.e678  Ethernet3
10.255.255.13     0:00:11  aac1.abe7.00a4  Ethernet4
10.255.255.17     0:00:06  aac1.ab93.4a95  Ethernet5
10.255.255.21     0:00:01  aac1.abd9.d1fc  Ethernet6
...
Router identifier 10.255.0.1, local AS number 65100
...
Neighbor Status Codes: m - Under maintenance
  ...
  Leaf1_Loopback0          10.255.0.3 4 65001            109       114    0    0 01:17:26 Estab   4      4      20
  Leaf2_Loopback0          10.255.0.4 4 65001            107       114    0    0 01:17:26 Estab   4      4      20
  Leaf3_Loopback0          10.255.0.5 4 65002            110       112    0    0 01:17:26 Estab   4      4      20
  Leaf4_Loopback0          10.255.0.6 4 65002            110       110    0    0 01:17:24 Estab   4      4      20
  Leaf5_Loopback0          10.255.0.7 4 65005            105       107    0    0 01:17:22 Estab   4      4      20
  Leaf6_Loopback0          10.255.0.8 4 65006            106       103    0    0 01:17:20 Estab   4      4      20
```
## show bgp summary
...
10.255.255.1        65001 Established   IPv4 Unicast            Negotiated              3          3         10
10.255.255.5        65001 Established   IPv4 Unicast            Negotiated              3          3          9
10.255.255.9        65002 Established   IPv4 Unicast            Negotiated              3          3          9
10.255.255.13       65002 Established   IPv4 Unicast            Negotiated              3          3         10
10.255.255.17       65005 Established   IPv4 Unicast            Negotiated              2          2          9
10.255.255.21       65006 Established   IPv4 Unicast            Negotiated              2          2          9
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_Leaf1_Ethernet1
Et2                            up             up                 P2P_Leaf2_Ethernet1
Et3                            up             up                 P2P_Leaf3_Ethernet1
Et4                            up             up                 P2P_Leaf4_Ethernet1
Et5                            up             up                 P2P_Leaf5_Ethernet1
Et6                            up             up                 P2P_Leaf6_Ethernet1
Lo0                            up             up                 ROUTER_ID
 ...
 * >      10.255.0.1/32          -                     -       -          -       0       i
 * >      10.255.0.3/32          10.255.255.1          0       -          100     0       65001 i
 *        10.255.0.3/32          10.255.255.5          0       -          100     0       65001 ?
 * >      10.255.0.4/32          10.255.255.5          0       -          100     0       65001 i
 *        10.255.0.4/32          10.255.255.1          0       -          100     0       65001 ?
 * >      10.255.0.5/32          10.255.255.9          0       -          100     0       65002 i
 *        10.255.0.5/32          10.255.255.13         0       -          100     0       65002 ?
 * >      10.255.0.6/32          10.255.255.13         0       -          100     0       65002 i
 *        10.255.0.6/32          10.255.255.9          0       -          100     0       65002 ?
 * >      10.255.0.7/32          10.255.255.17         0       -          100     0       65005 i
 * >      10.255.0.8/32          10.255.255.21         0       -          100     0       65006 i
 * >Ec    192.168.1.3/32         10.255.255.5          0       -          100     0       65001 i
 *  ec    192.168.1.3/32         10.255.255.1          0       -          100     0       65001 i
 * >Ec    192.168.1.5/32         10.255.255.9          0       -          100     0       65002 i
 *  ec    192.168.1.5/32         10.255.255.13         0       -          100     0       65002 i
 * >      192.168.1.7/32         10.255.255.17         0       -          100     0       65005 i
 * >      192.168.1.8/32         10.255.255.21         0       -          100     0       65006 i
```
## show ip route
...
Gateway of last resort:
 ...
 B E      10.255.0.3/32 [20/0]
           via 10.255.255.1, Ethernet1
 B E      10.255.0.4/32 [20/0]
           via 10.255.255.5, Ethernet2
 B E      10.255.0.5/32 [20/0]
           via 10.255.255.9, Ethernet3
 B E      10.255.0.6/32 [20/0]
           via 10.255.255.13, Ethernet4
 B E      10.255.0.7/32 [20/0]
           via 10.255.255.17, Ethernet5
 B E      10.255.0.8/32 [20/0]
           via 10.255.255.21, Ethernet6
 C        10.255.255.0/31
...
Number of table inserts  : 3507
Number of table deletes  : 3485
Number of table drops    : 0
Number of table age-outs : 3485
...
Et4           Leaf4                    Ethernet1           120
Et5           Leaf5                    Ethernet1           120
Et6           Leaf6                    Ethernet1           120
...
Arista cEOSLab
Hardware version: 
Serial number: SERHATSPINE1
Hardware MAC address: 001c.eaae.89c3
System MAC address: 001c.eaae.89c3
