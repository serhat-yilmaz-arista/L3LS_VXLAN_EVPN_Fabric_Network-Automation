...
10.255.255.16     0:00:30  aac1.abb1.a57a  Ethernet1
10.255.255.18     0:00:13  aac1.abfe.59d2  Ethernet2
...
Router identifier 10.255.0.7, local AS number 65005
...
Neighbor Status Codes: m - Under maintenance
  ...
  Spine1_Loopback0         10.255.0.1 4 65100            107       106    0    0 01:17:32 Estab   20     20     9
  Spine2_Loopback0         10.255.0.2 4 65100            108       108    0    0 01:17:32 Estab   20     20     19
```
## show bgp summary
...
------------- ----------- ------------- ----------------------- -------------- ---------- ---------- ----------
10.255.0.1          65100 Established   L2VPN EVPN              Negotiated             20         20          9
10.255.0.2          65100 Established   L2VPN EVPN              Negotiated             20         20         19
10.255.255.16       65100 Established   IPv4 Unicast            Negotiated              9          9          3
10.255.255.18       65100 Established   IPv4 Unicast            Negotiated              9          9         11
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_Spine1_Ethernet5
Et2                            up             up                 P2P_Spine2_Ethernet5
Et5                            up             up                 SERVER_Host-E_Ethernet1
Et6                            up             up                 SERVER_Host-F_Ethernet1
Lo0                            up             up                 ROUTER_ID
 ...
 * >      10.255.0.1/32          10.255.255.16         0       -          100     0       65100 i
 * >      10.255.0.2/32          10.255.255.18         0       -          100     0       65100 i
 * >Ec    10.255.0.3/32          10.255.255.16         0       -          100     0       65100 65001 i
 *  ec    10.255.0.3/32          10.255.255.18         0       -          100     0       65100 65001 i
 * >Ec    10.255.0.4/32          10.255.255.16         0       -          100     0       65100 65001 i
 *  ec    10.255.0.4/32          10.255.255.18         0       -          100     0       65100 65001 i
 * >Ec    10.255.0.5/32          10.255.255.16         0       -          100     0       65100 65002 i
 *  ec    10.255.0.5/32          10.255.255.18         0       -          100     0       65100 65002 i
 * >Ec    10.255.0.6/32          10.255.255.16         0       -          100     0       65100 65002 i
 *  ec    10.255.0.6/32          10.255.255.18         0       -          100     0       65100 65002 i
 * >      10.255.0.7/32          -                     -       -          -       0       i
 * >Ec    10.255.0.8/32          10.255.255.16         0       -          100     0       65100 65006 i
 *  ec    10.255.0.8/32          10.255.255.18         0       -          100     0       65100 65006 i
 * >Ec    192.168.1.3/32         10.255.255.16         0       -          100     0       65100 65001 i
 *  ec    192.168.1.3/32         10.255.255.18         0       -          100     0       65100 65001 i
 * >Ec    192.168.1.5/32         10.255.255.16         0       -          100     0       65100 65002 i
 *  ec    192.168.1.5/32         10.255.255.18         0       -          100     0       65100 65002 i
 * >      192.168.1.7/32         -                     -       -          -       0       i
 * >Ec    192.168.1.8/32         10.255.255.16         0       -          100     0       65100 65006 i
 *  ec    192.168.1.8/32         10.255.255.18         0       -          100     0       65100 65006 i
```
## show ip route
...
Gateway of last resort:
 ...
 B E      10.255.0.1/32 [20/0]
           via 10.255.255.16, Ethernet1
 B E      10.255.0.2/32 [20/0]
           via 10.255.255.18, Ethernet2
...
```
Last table change time   : 0:02:27 ago
Number of table inserts  : 3314
Number of table deletes  : 3294
Number of table drops    : 0
Number of table age-outs : 3294

Port          Neighbor Device ID       Neighbor Port ID    TTL
---------- ------------------------ ---------------------- ---
Et1           Spine1                   Ethernet5           120
Et2           Spine2                   Ethernet5           120
Et5           Host-E                   Ethernet1           120
Et6           Host-F                   Ethernet1           120
...
Arista cEOSLab
Hardware version: 
Serial number: SERHATLEAF5
Hardware MAC address: 001c.eaae.d9dd
System MAC address: 001c.eaae.d9dd
