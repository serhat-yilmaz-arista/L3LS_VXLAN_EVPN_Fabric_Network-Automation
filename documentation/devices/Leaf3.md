...
| Ethernet5 | SERVER_Host-C_Ethernet1 | *trunk | *10,20 | *- | *- | 5 |
| Ethernet6 | SERVER_Host-D_Ethernet1 | *trunk | *10,20 | *- | *- | 6 |
...
| Loopback10 | DIAG_VRF_VRF_10 | VRF_10 | 10.255.10.5/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan21 | VRF_10_VLAN_21 | VRF_10 | - | False |
| Vlan22 | VRF_10_VLAN_22 | VRF_10 | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan21 |  VRF_10  |  -  |  10.10.21.1/24  |  -  |  -  |  -  |
| Vlan22 |  VRF_10  |  -  |  10.10.22.1/24  |  -  |  -  |  -  |
| Vlan3009 |  VRF_10  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |
...
!
interface Vlan21
   description VRF_10_VLAN_21
   no shutdown
   vrf VRF_10
   ip address virtual 10.10.21.1/24
!
interface Vlan22
   description VRF_10_VLAN_22
   no shutdown
   vrf VRF_10
...
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| VRF_10 | 10.255.0.5:10 | connected | - |
...
```eos
!
ip address virtual source-nat vrf VRF_10 address 10.255.10.5
```
