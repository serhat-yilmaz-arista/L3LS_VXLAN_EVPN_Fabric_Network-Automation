...
| Ethernet5 | SERVER_Host-A_Ethernet1 | *trunk | *11 | *- | *- | 5 |
| Ethernet6 | SERVER_Host-B_Ethernet1 | *trunk | *12 | *- | *- | 6 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.1.3/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 1.1.1.3/32 |
...
| Vlan3009 |  CUSTOMER_VRF  |  10.255.1.96/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.97 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CUSTOMER_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| CUSTOMER_VRF | 10.1.1.3:10 | connected | - |
