...
10.255.255.8      0:00:16  aac1.aba2.2460  Ethernet1
10.255.255.10     0:00:17  aac1.ab18.d303  Ethernet2
10.255.1.101      0:00:55  001c.eaae.6ea0  Vlan4093, Port-Channel3
10.255.1.69       0:00:02  001c.eaae.6ea0  Vlan4094, Port-Channel3
...
Router identifier 10.255.0.5, local AS number 65002
 ...
 *  ec    RD: 10.255.0.4:10 ip-prefix 10.10.11.0/24
                                 192.168.1.3           -       100     0       65100 65001 i
 * >      RD: 10.255.0.5:10 ip-prefix 10.10.11.0/24
                                 -                     -       100     0       65100 65001 ?
 ...
 *  ec    RD: 10.255.0.4:10 ip-prefix 10.10.12.0/24
                                 192.168.1.3           -       100     0       65100 65001 i
 * >      RD: 10.255.0.5:10 ip-prefix 10.10.12.0/24
                                 -                     -       100     0       65100 65001 ?
 ...
 *        RD: 10.255.0.5:10 ip-prefix 10.10.22.0/24
                                 -                     -       100     0       ?
 * >      RD: 10.255.0.5:10 ip-prefix 10.10.31.0/24
                                 -                     -       100     0       65100 65005 ?
 ...
 *  ec    RD: 10.255.0.8:10 ip-prefix 10.10.31.0/24
                                 192.168.1.8           -       100     0       65100 65006 i
 * >      RD: 10.255.0.5:10 ip-prefix 10.10.32.0/24
                                 -                     -       100     0       65100 65005 ?
...
Neighbor Status Codes: m - Under maintenance
  ...
  Spine1_Loopback0         10.255.0.1 4 65100            112       109    0    0 01:17:26 Estab   16     16     14
  Spine2_Loopback0         10.255.0.2 4 65100            110       115    0    0 01:17:26 Estab   16     16     18
```
## show bgp summary
...
10.255.1.101        65002 Established   IPv4 Unicast            Negotiated             11         11         11
10.255.255.8        65100 Established   IPv4 Unicast            Negotiated              8          8          9
10.255.255.10       65100 Established   IPv4 Unicast            Negotiated              8          8          6
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_Spine1_Ethernet3
Et2                            up             up                 P2P_Spine2_Ethernet3
Et3                            up             up                 MLAG_Leaf4_Ethernet3
Et4                            up             up                 MLAG_Leaf4_Ethernet4
Et5                            up             up                 SERVER_Host-C_Ethernet1
Et6                            up             up                 SERVER_Host-D_Ethernet1
Lo0                            up             up                 ROUTER_ID
Lo1                            up             up                 VXLAN_TUNNEL_SOURCE
Ma0                            up             up                 OOB_MANAGEMENT
Po3                            up             up                 MLAG_Leaf4_Port-Channel3
 ...
 * >      10.255.0.1/32          10.255.255.8          0       -          100     0       65100 i
 *        10.255.0.1/32          10.255.1.101          0       -          100     0       65100 ?
 * >      10.255.0.2/32          10.255.255.10         0       -          100     0       65100 i
 *        10.255.0.2/32          10.255.1.101          0       -          100     0       65100 ?
 * >Ec    10.255.0.3/32          10.255.255.10         0       -          100     0       65100 65001 i
 *  ec    10.255.0.3/32          10.255.255.8          0       -          100     0       65100 65001 i
 *        10.255.0.3/32          10.255.1.101          0       -          100     0       65100 65001 ?
 * >Ec    10.255.0.4/32          10.255.255.10         0       -          100     0       65100 65001 i
 *  ec    10.255.0.4/32          10.255.255.8          0       -          100     0       65100 65001 i
 *        10.255.0.4/32          10.255.1.101          0       -          100     0       65100 65001 ?
 * >      10.255.0.5/32          -                     -       -          -       0       i
 * >      10.255.0.6/32          10.255.1.101          0       -          100     0       ?
 * >Ec    10.255.0.7/32          10.255.255.10         0       -          100     0       65100 65005 i
 *  ec    10.255.0.7/32          10.255.255.8          0       -          100     0       65100 65005 i
 *        10.255.0.7/32          10.255.1.101          0       -          100     0       65100 65005 ?
 * >Ec    10.255.0.8/32          10.255.255.8          0       -          100     0       65100 65006 i
 *  ec    10.255.0.8/32          10.255.255.10         0       -          100     0       65100 65006 i
 *        10.255.0.8/32          10.255.1.101          0       -          100     0       65100 65006 ?
 * >Ec    192.168.1.3/32         10.255.255.10         0       -          100     0       65100 65001 i
 *  ec    192.168.1.3/32         10.255.255.8          0       -          100     0       65100 65001 i
 *        192.168.1.3/32         10.255.1.101          0       -          100     0       65100 65001 ?
 * >      192.168.1.5/32         -                     -       -          -       0       i
 *        192.168.1.5/32         10.255.1.101          0       -          100     0       ?
 * >Ec    192.168.1.7/32         10.255.255.10         0       -          100     0       65100 65005 i
 *  ec    192.168.1.7/32         10.255.255.8          0       -          100     0       65100 65005 i
 *        192.168.1.7/32         10.255.1.101          0       -          100     0       65100 65005 ?
 * >Ec    192.168.1.8/32         10.255.255.8          0       -          100     0       65100 65006 i
 *  ec    192.168.1.8/32         10.255.255.10         0       -          100     0       65100 65006 i
 *        192.168.1.8/32         10.255.1.101          0       -          100     0       65100 65006 ?
```
## show ip route
...
Gateway of last resort:
 ...
 B I      10.255.0.6/32 [200/0]
           via 10.255.1.101, Vlan4093
...
```
Last table change time   : 0:09:13 ago
Number of table inserts  : 2996
Number of table deletes  : 2974
Number of table drops    : 0
Number of table age-outs : 2974

Port          Neighbor Device ID       Neighbor Port ID    TTL
---------- ------------------------ ---------------------- ---
Et1           Spine1                   Ethernet3           120
Et2           Spine2                   Ethernet3           120
Et3           Leaf4                    Ethernet3           120
Et4           Leaf4                    Ethernet4           120
Et5           Host-C                   Ethernet1           120
Et6           Host-D                   Ethernet1           120
...
!
interface Ethernet5
   description SERVER_Host-C_Ethernet1
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_Host-D_Ethernet1
...
Arista cEOSLab
Hardware version: 
Serial number: SERHATLEAF3
Hardware MAC address: 001c.eaae.13b2
System MAC address: 001c.eaae.13b2
