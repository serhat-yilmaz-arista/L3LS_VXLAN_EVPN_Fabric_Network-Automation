...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | default | 172.20.20.68/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAFS_POD2 | Vlan4094 | 10.255.1.68 | Port-Channel3 |
...
| Ethernet5 | SERVER_Host-C_Ethernet2 | *trunk | *10,20 | *- | *- | 5 |
| Ethernet6 | SERVER_Host-D_Ethernet2 | *trunk | *10,20 | *- | *- | 6 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_Spine1_Ethernet4 | - | 10.255.255.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_Spine2_Ethernet4 | - | 10.255.255.15/31 | default | 1500 | False | - | - |
...
| Loopback10 | DIAG_VRF_VRF_10 | VRF_10 | 10.255.10.6/32 |
...
| Vlan3009 |  VRF_10  |  10.255.1.101/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.100 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| VRF_10 | 10.255.0.6:10 | connected | - |
...
```eos
!
ip address virtual source-nat vrf VRF_10 address 10.255.10.6
```
