...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | SERVER_Host-E_Ethernet1 | *trunk | *31 | *- | *- | 5 |
| Ethernet6 | SERVER_Host-F_Ethernet1 | *trunk | *32 | *- | *- | 6 |
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.1.7/32 |
| Loopback10 | DIAG_VRF_VRF_A | VRF_A | 10.255.10.7/32 |
