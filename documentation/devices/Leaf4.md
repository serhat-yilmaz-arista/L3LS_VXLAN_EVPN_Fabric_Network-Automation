...
| Vlan3009 |  CUSTOMER_VRF  |  10.255.1.101/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.100 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CUSTOMER_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| CUSTOMER_VRF | 10.1.1.6:10 | connected | - |
