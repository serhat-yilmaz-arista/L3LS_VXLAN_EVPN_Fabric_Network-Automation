...
10.255.255.4      0:00:10  aac1.ab5c.199c  Ethernet1
10.255.255.6      0:00:30  aac1.abf8.0879  Ethernet2
10.255.1.96       0:00:32  001c.eaae.866b  Vlan4093, Port-Channel3
10.255.1.64       0:00:02  001c.eaae.866b  Vlan4094, Port-Channel3
...
Router identifier 10.255.0.4, local AS number 65001
 ...
 *        RD: 10.255.0.4:10 ip-prefix 10.10.12.0/24
                                 -                     -       100     0       ?
 * >      RD: 10.255.0.4:10 ip-prefix 10.10.21.0/24
                                 -                     -       100     0       65100 65002 ?
 ...
 *  ec    RD: 10.255.0.6:10 ip-prefix 10.10.21.0/24
                                 192.168.1.5           -       100     0       65100 65002 i
 * >      RD: 10.255.0.4:10 ip-prefix 10.10.22.0/24
                                 -                     -       100     0       65100 65002 ?
 ...
 *  ec    RD: 10.255.0.6:10 ip-prefix 10.10.22.0/24
                                 192.168.1.5           -       100     0       65100 65002 i
 * >      RD: 10.255.0.4:10 ip-prefix 10.10.31.0/24
                                 -                     -       100     0       65100 65006 ?
 ...
 *  ec    RD: 10.255.0.8:10 ip-prefix 10.10.31.0/24
                                 192.168.1.8           -       100     0       65100 65006 i
 * >      RD: 10.255.0.4:10 ip-prefix 10.10.32.0/24
                                 -                     -       100     0       65100 65006 ?
...
Neighbor Status Codes: m - Under maintenance
  ...
  Spine1_Loopback0         10.255.0.1 4 65100            114       107    0    0 01:17:26 Estab   16     16     13
  Spine2_Loopback0         10.255.0.2 4 65100            114       115    0    0 01:17:26 Estab   16     16     19
```
## show bgp summary
...
------------ ----------- ------------- ----------------------- -------------- ---------- ---------- ----------
10.255.0.1         65100 Established   L2VPN EVPN              Negotiated             16         16         13
10.255.0.2         65100 Established   L2VPN EVPN              Negotiated             16         16         19
10.255.1.96        65001 Established   IPv4 Unicast            Negotiated             11         11         11
10.255.255.4       65100 Established   IPv4 Unicast            Negotiated              8          8          9
10.255.255.6       65100 Established   IPv4 Unicast            Negotiated              8          8          6
```
## show interfaces description

```
Interface                      Status         Protocol           Description
Et1                            up             up                 P2P_Spine1_Ethernet2
Et2                            up             up                 P2P_Spine2_Ethernet2
Et3                            up             up                 MLAG_Leaf1_Ethernet3
Et4                            up             up                 MLAG_Leaf1_Ethernet4
Et5                            up             up                 SERVER_Host-A_Ethernet2
Et6                            up             up                 SERVER_Host-B_Ethernet2
Lo0                            up             up                 ROUTER_ID
Lo1                            up             up                 VXLAN_TUNNEL_SOURCE
Ma0                            up             up                 OOB_MANAGEMENT
Po3                            up             up                 MLAG_Leaf1_Port-Channel3
 ...
 * >      10.255.0.1/32          10.255.255.4          0       -          100     0       65100 i
 *        10.255.0.1/32          10.255.1.96           0       -          100     0       65100 ?
 * >      10.255.0.2/32          10.255.255.6          0       -          100     0       65100 i
 *        10.255.0.2/32          10.255.1.96           0       -          100     0       65100 ?
 * >      10.255.0.3/32          10.255.1.96           0       -          100     0       ?
 * >      10.255.0.4/32          -                     -       -          -       0       i
 * >Ec    10.255.0.5/32          10.255.255.6          0       -          100     0       65100 65002 i
 *  ec    10.255.0.5/32          10.255.255.4          0       -          100     0       65100 65002 i
 *        10.255.0.5/32          10.255.1.96           0       -          100     0       65100 65002 ?
 * >Ec    10.255.0.6/32          10.255.255.6          0       -          100     0       65100 65002 i
 *  ec    10.255.0.6/32          10.255.255.4          0       -          100     0       65100 65002 i
 *        10.255.0.6/32          10.255.1.96           0       -          100     0       65100 65002 ?
 * >Ec    10.255.0.7/32          10.255.255.6          0       -          100     0       65100 65005 i
 *  ec    10.255.0.7/32          10.255.255.4          0       -          100     0       65100 65005 i
 *        10.255.0.7/32          10.255.1.96           0       -          100     0       65100 65005 ?
 * >Ec    10.255.0.8/32          10.255.255.4          0       -          100     0       65100 65006 i
 *  ec    10.255.0.8/32          10.255.255.6          0       -          100     0       65100 65006 i
 *        10.255.0.8/32          10.255.1.96           0       -          100     0       65100 65006 ?
 * >      192.168.1.3/32         -                     -       -          -       0       i
 *        192.168.1.3/32         10.255.1.96           0       -          100     0       ?
 * >Ec    192.168.1.5/32         10.255.255.6          0       -          100     0       65100 65002 i
 *  ec    192.168.1.5/32         10.255.255.4          0       -          100     0       65100 65002 i
 *        192.168.1.5/32         10.255.1.96           0       -          100     0       65100 65002 ?
 * >Ec    192.168.1.7/32         10.255.255.6          0       -          100     0       65100 65005 i
 *  ec    192.168.1.7/32         10.255.255.4          0       -          100     0       65100 65005 i
 *        192.168.1.7/32         10.255.1.96           0       -          100     0       65100 65005 ?
 * >Ec    192.168.1.8/32         10.255.255.4          0       -          100     0       65100 65006 i
 *  ec    192.168.1.8/32         10.255.255.6          0       -          100     0       65100 65006 i
 *        192.168.1.8/32         10.255.1.96           0       -          100     0       65100 65006 ?
```
## show ip route
...
Gateway of last resort:
 ...
 B E      10.255.0.1/32 [20/0]
           via 10.255.255.4, Ethernet1
 B E      10.255.0.2/32 [20/0]
           via 10.255.255.6, Ethernet2
 B I      10.255.0.3/32 [200/0]
           via 10.255.1.96, Vlan4093
 C        10.255.0.4/32
...
Number of table inserts  : 3470
Number of table deletes  : 3448
Number of table drops    : 0
Number of table age-outs : 3448

Port          Neighbor Device ID       Neighbor Port ID    TTL
---------- ------------------------ ---------------------- ---
Et1           Spine1                   Ethernet2           120
Et2           Spine2                   Ethernet2           120
Et3           Leaf1                    Ethernet3           120
Et4           Leaf1                    Ethernet4           120
Et5           Host-A                   Ethernet2           120
Et6           Host-B                   Ethernet2           120
...
!
interface Ethernet5
   description SERVER_Host-A_Ethernet2
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_Host-B_Ethernet2
...
Arista cEOSLab
Hardware version: 
Serial number: SERHATLEAF2
Hardware MAC address: 001c.eaae.5796
System MAC address: 001c.eaae.5796
