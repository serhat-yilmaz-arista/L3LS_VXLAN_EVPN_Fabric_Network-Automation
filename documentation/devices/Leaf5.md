...
| --------- | --------------- | ------------ | --------- |
| LEAFS_POD3 | Vlan4094 | 10.255.1.73 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_Leaf6_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_Leaf6_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_Host-E_Ethernet1 | *trunk | *10,20 | *- | *- | 5 |
| Ethernet6 | SERVER_Host-F_Ethernet1 | *trunk | *10,20 | *- | *- | 6 |
...
!
interface Ethernet3
   description MLAG_Leaf6_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_Leaf6_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_Leaf6_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_Leaf6_Port-Channel3
   no shutdown
...
router bgp 65005
   ...
   neighbor 10.255.1.105 description Leaf6_Vlan4093
